...
_perf_info = namedtuple('AccelStats', ['lfa_runs', 'lfa_time', 'uq_time',
...
def lfa(inference_engine: BaseInferenceEngine, uq_engine: BaseUQEngine,
    ...
    def decorating_function(target_function):
        ...
        lfa_runs = lfa_time = uq_time = target_runs = target_time = 0

        # Make the decorator
        def decorator(*args, **kwargs):
            """Wrapper function for the target function"""

            nonlocal lfa_runs, lfa_time, uq_time, target_runs, target_time
        ...
        def _get_perf_info():
            return _perf_info(lfa_runs, lfa_time, uq_time, target_runs, target_time)
